...
and linea alba
joining its fellow
from other side', 'Lateral third of
inguinal ligament,
inner rim of iliac
crest, inner surface
...
('interspinalis', 'spine', 'Spinous process of
next vertebra', 'Spinous process of
each vertebra', 'lumbar extension', 'sagittal plane'), 

('quadratus lumborum', 'spine', 'Approximately one-half
length of lower border of the
...
above origin', 'Sacrum, iliac spine,
